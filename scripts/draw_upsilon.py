...
def make_hists():
    ...
    for ientry in xrange(nentries):
        ...
        h_upsilon.Fill(mU)
        m4l = tree.m4l
        has_4l = tree.n_muon > 3 and tree.m4l > 0 and tree.vtx4l_chi2ndf < chi2_cut and tree.vtx4l_chi2ndf > 0
...
def draw(file_name):
    ...
    canvas.SaveAs("mUpsilon"+post_fix+".pdf")
    ...
    canvas.SaveAs("m4l_LHS"+post_fix+".pdf")
    ...
    canvas.SaveAs("m4l_RHS_U1"+post_fix+".pdf")
    ...
    canvas.SaveAs("m4l_RHS_U2"+post_fix+".pdf")
    ...
    canvas.SaveAs("m4l"+post_fix+".pdf")
    ...
    canvas.SaveAs("mJpsi"+post_fix+".pdf")

if __name__ == "__main__":
    #file_name = "data16.merged.root"
    #make_hists("data16.merged.p2689.root")
    file_name = make_hists()
    draw(file_name)
    #draw("hist_merged_chi2Cut.root")
